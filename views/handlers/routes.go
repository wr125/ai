...
func SetupRoutes(e *echo.Echo, ah *AuthHandler, th *TaskHandler) {
	...
	protectedGroup.GET("/haircut", th.haircutTypeHandler)
	protectedGroup.GET("/update", th.haircutTypeHandler)
	protectedGroup.GET("/registration", th.haircutTypeHandler)
	protectedGroup.GET("/device", th.haircutTypeHandler)
	protectedGroup.GET("/subcription", th.haircutTypeHandler)
	protectedGroup.GET("/data", th.haircutTypeHandler)
