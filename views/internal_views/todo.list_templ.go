...
import (
	...
	"github.com/wr125/ai/views/layout"
...
func TodoList(titlePage string, todos []services.Todo) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views\internal_views\todo.list.templ`, Line: 14, Col: 34}
		}
		...
		if len(todos) != 0 {
			...
			for _, todo := range todos {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views\internal_views\todo.list.templ`, Line: 35, Col: 39}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views\internal_views\todo.list.templ`, Line: 36, Col: 23}
				}
				...
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" class=\"badge badge-neutral p-3 hover:scale-[1.1]\">Edit</a> <button hx-swap=\"transition:true\" hx-delete=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
